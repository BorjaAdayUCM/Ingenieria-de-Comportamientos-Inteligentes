...
public class FSMHome extends FSM{

	protected FSMHome(ArrayList<State> listaEstados, ArrayList<Transicion> listaTransiciones, String id) {
		super(listaEstados, listaTransiciones, id);
	}

	@Override
	protected void initFSM() {
		this.estadoInicial = this.getState("StateHome");
		this.estadoActual = this.getState("StateHome");
	}
