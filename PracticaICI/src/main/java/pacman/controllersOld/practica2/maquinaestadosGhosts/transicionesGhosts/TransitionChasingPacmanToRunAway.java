...
public class TransitionChasingPacmanToRunAway extends Transicion {

	public TransitionChasingPacmanToRunAway(String id) {
		super(id);
	}
	...
	protected boolean check(Game game, GHOST ghost) {
		return UtilsGhosts.amIEdible(game, ghost) && 
