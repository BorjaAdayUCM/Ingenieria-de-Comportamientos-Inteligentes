...
public class TransitionSlippingAwayToSuicide extends Transicion {

	public TransitionSlippingAwayToSuicide(String id) {
		super(id);
	}
	...
	protected boolean check(Game game, GHOST ghost) {
		return (UtilsGhosts.getNumSuicideGhost() < UtilsGhosts.getLimitSuicideGhost()) && 
