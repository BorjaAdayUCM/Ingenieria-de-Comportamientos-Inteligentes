...
public class StateComerG extends State {

	public StateComerG(String id) {
		super(id);
	}

	@Override
	public MOVE doAction(Game game) {
		//Ir a por el GhostEdible mas cercano
		...
		for (GHOST ghostType : GHOST.values())
		{
			if(game.isGhostEdible(ghostType))
			{
				...
				MOVE possibleMove = game.getNextMoveTowardsTarget(nodoPacman, nodoGhost, DM.PATH);
